<template>
    <div>
        <el-dialog
            width="80%"
            :title="`${form.buildYear||''}部门营收调整明细选择`"
        ...
        >
            ...
            <div class="table-page">
                <el-pagination
                    ...
                    :current-page="form[sizeMap[mode]]"
                    :page-sizes="[10, 20, 50, 100]"
                    :page-size="form[pageMap[mode]]"
...
export default {
    ...
    methods: {
        onSearch(){
            this.form[this.pageMap[this.mode]] = 1
            this.getSelectAdjustUpload()
        },
            ...
            this.apiFn(this.form)
                .then(res => {
                    ...
                    if (res.data.code == 0 && res.data.extra) {
                        ...
                        if(this.mode == 'reSelect' || this.mode == 'selectAll'){
                            this.$nextTick(() => {
        ...
        handleSizeChange(val) {
            this.form[this.sizeMap[this.mode]] = val;
            this.getSelectAdjustUpload();
        },
        handleCurrentChange(val) {
            this.form[this.pageMap[this.mode]] = val;
            this.getSelectAdjustUpload();
        },
